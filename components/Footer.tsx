          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-16">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-2">
                ...
                {/* Email — bright green bullet, mid-tone text */}
                <a
                  href="mailto:hello@abdullah.dev"
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-sm bg-[#80eb34] shrink-0" />
                  hello@abdullah.dev
                </a>
                {/* LinkedIn — lighter green shade bullet */}
                <a
                  href="https://linkedin.com"
                  className="group flex items-center gap-2.5 text-sm font-mono text-[#3a3a36] dark:text-[#c8c8be] hover:text-[#5cba1d] dark:hover:text-[#80eb34] transition-colors duration-200"
                >
                  <span className="w-1.5 h-1.5 rounded-sm bg-[#b1f08a] dark:bg-[#5cba1d] shrink-0" />
